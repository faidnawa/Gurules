...
class MainAdapterGuru (
    private val content: List<Sortdataa>,
    private val onClickListener: (Sortdataa) -> Unit

) :
    RecyclerView.Adapter<MainAdapterGuru.MainViewHolder>(){
    ...
    class MainViewHolder(override val containerView: View) :
        ...
        fun bind(content: Sortdataa, onClickListener: (Sortdataa) -> Unit) {
